...
<html>
    <head>
        <meta charset="utf-8">
        <title>Registro Usuario - BIBLIOSENA</title>
    ...
    <body class="loaded">
        ...
        <div class="container-fluid page-header mb-5 position-relative overlay-bottom" data-aos="fade-down">
            <div class="d-flex flex-column align-items-center justify-content-center pt-5">
                <h1 class="display-3 text-white">Registrar Usuario</h1>
                <h4 class="text-white">Llena toda la información</h4>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form action="registrarUsuarioServlet" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contrasenia" class="form-control p-3"
