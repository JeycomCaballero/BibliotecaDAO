...
<html>
    <head>
        <meta charset="utf-8">
        <title>Editar Autor - BIBLIOSENA</title>
    ...
    <body class="loaded">
        ...
        <div class="container-fluid page-header mb-5 position-relative overlay-bottom" data-aos="fade-down">
            <div class="d-flex flex-column align-items-center justify-content-center pt-5">
                <h1 class="display-3 text-white" data-aos="fade-down">Editar Autor</h1>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="form-card" data-aos="zoom-in">
                        ...
                        <div class="card-body">
                            ...
                            <form action="editarAutorServlet" method="POST">
                                ...
                                <div class="text-center mt-4">
                                    ...
                                    <a href="listaAutorServlet" class="btn btn-secondary px-4 ml-2">Cancelar</a>
                                </div>
