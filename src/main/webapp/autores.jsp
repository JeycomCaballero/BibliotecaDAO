...
<html>
    <head>
        <meta charset="utf-8">
        <title>Autores - BIBLIOSENA</title>
    ...
    <body class="loaded">
        ...
        <div class="container py-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-up">
                ...
                <!-- BOTON REGISTRAR -->
                <a href="registroAutor.jsp" class="btn btn-primary btn-lg">
                            ...
                            <c:when test="${not empty autores}">
                                <c:forEach var="a" items="${autores}">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-warning btn-sm btn-editar" data-id="${a.id}">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a href="#" class="btn btn-danger btn-sm btn-eliminar" data-id="${a.id}">
        ...
        <script>
                ...
                btn.addEventListener("click", function () {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = "eliminarAutorServlet?id=" + id;
                        }
                    });
                });
            });
            ...
            document.querySelectorAll(".btn-editar").forEach(btn => {
                btn.addEventListener("click", function () {
                    let id = this.getAttribute("data-id");
                    window.location.href = "editarAutorServlet?id=" + id;
                });
            });
        </script>
