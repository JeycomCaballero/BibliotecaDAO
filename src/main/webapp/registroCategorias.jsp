...
<html>
    <head>
        <meta charset="utf-8">
        <title>Registro Categoria - BIBLIOSENA</title>
    ...
    <body class="loaded">
        ...
        <div class="container-fluid page-header mb-5 position-relative overlay-bottom" data-aos="fade-down">
            <div class="d-flex flex-column align-items-center justify-content-center pt-5">
                <h1 class="display-3 text-white" data-aos="fade-down" data-aos-duration="1200">Registrar Categoria</h1>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="form-card" data-aos="zoom-in">
                        ...
                        <div class="card-body">
                            ...
                            <form action="registrarCategoriasServlet" method="POST">
