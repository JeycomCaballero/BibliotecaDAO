...
<html>
    <head>
        <meta charset="utf-8">
        <title>Categorias - BIBLIOSENA</title>
    ...
    <body class="loaded">
        ...
        <div class="container-fluid page-header mb-5 position-relative overlay-bottom" data-aos="fade-down">
            <div class="d-flex flex-column align-items-center justify-content-center pt-5">
                <h1 class="display-3 text-white">Gestión de Categorias</h1>
                <h4 class="text-white">Administra las Categorias</h4>
            </div>
        </div>
        ...
        <div class="container py-5">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4" data-aos="fade-up">
                ...
                <!-- BOTON REGISTRAR -->
                <a href="registroCategorias.jsp" class="btn btn-primary btn-lg">
                        ...
                        <c:choose>
                            ...
                            <c:when test="${not empty categorias}">
                                <c:forEach var="c" items="${categorias}">
                                    <tr data-aos="fade-up" data-aos-delay="${c.id * 50}">
                                        ...
                                        <td>
                                            ...
                                            <!-- EDITAR --> 
                                            <a href="#" class="btn btn-warning btn-sm btn-editar" data-id="${c.id}">
                                                <i class="fa fa-edit"></i>
                                            </a> 
                                            <!-- ELIMINAR --> 
                                            <a href="#" class="btn btn-danger btn-sm btn-eliminar" data-id="${c.id}"> 
                            ...
                            <c:otherwise>
                                <tr>
                                    <td colspan="8">No hay Categorias registradas</td>
                                </tr>
                            </c:otherwise>
            ...
            document.addEventListener("DOMContentLoaded", function () {
                    ...
                    btn.addEventListener("click", function () {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = "eliminarCategoriaServlet?id=" + id;
                            }
                        });
                ...
                document.querySelectorAll(".btn-editar").forEach(btn => {
                    btn.addEventListener("click", function () {
                        ...
                        window.location.href = "editarCategoriaServlet?id=" + id;
                    });
                });
                ...
                if (result === "editado") {
                    Swal.fire({
                        icon: "success",
                        title: "Editado",
                        text: "La Categoria fue editado correctamente",
                        timer: 2000,
                        showConfirmButton: false
                    });
                }
                ...
                if (regist === "registrado") {
                    Swal.fire({
                        icon: "success",
                        title: "Registrado",
                        text: "La Categoria fue registrada correctamente",
                        timer: 2000,
                        showConfirmButton: false
                    });
                }
